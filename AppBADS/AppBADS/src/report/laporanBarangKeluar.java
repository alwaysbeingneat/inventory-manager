...
import static report.laporanBarangMasuk.maximixed;
...
public class laporanBarangKeluar extends javax.swing.JDialog {
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from detail_barang_keluar where id_bk like '%"+txtCari.getText()+"%' or nama_part like '%"+txtCari.getText()+"%'";
    ...
    private void btnTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTampilActionPerformed
        ...
        String sql = "select * from detail_barang_keluar where tanggal between '"+tanggalAwal+"' and '"+tanggalAkhir+"'";
        try{
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()){
