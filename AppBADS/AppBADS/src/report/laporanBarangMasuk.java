...
public class laporanBarangMasuk extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnTampil.setBackground(new java.awt.Color(189, 195, 199));
        btnTampil.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from detail_barang_masuk where id_bm like '%"+txtCari.getText()+"%' or nama_part like '%"+txtCari.getText()+"%'";
    ...
    private void btnTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTampilActionPerformed
        ...
        String sql = "select * from detail_barang_masuk where tanggal between '"+tanggalAwal+"' and '"+tanggalAkhir+"'";
        try{
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()){
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            ...
            File file = new File("src/report/laporanBM.jrxml");
            String tampilan = "dd-MM-yyyy";
            SimpleDateFormat fm = new SimpleDateFormat(tampilan);
            String tanggalAwal = String.valueOf(fm.format(tglAwal.getDate()));
            String tanggalAkhir = String.valueOf(fm.format(tglAkhir.getDate()));
