...
public class dataKategori extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        labelKodeKategori.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
        ...
        labelNamaKategori.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update kategori set tanggal=?,kode_kategori=?,nama_kategori=?,keterangan=? where kode_kategori='"+txtKodeKategori.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (ok==0){
            String sql="delete from kategori where kode_kategori='"+txtKodeKategori.getText()+"'";
            try {
                PreparedStatement stat=conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from kategori where kode_kategori like '%"+txtCari.getText()+"%' or nama_kategori like '%"+txtCari.getText()+"%'";
