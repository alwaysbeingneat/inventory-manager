...
import static appbads.transaksiBarangMasuk.maximixed;
...
public class transaksiBarangKeluar extends javax.swing.JDialog {
    ...
    private void autoIdBK(){
     try{
         ...
         String sql = "select max(right (id_bk,6)) as no from barang_keluar";
    ...
    private void autoIdBK_DT(){
     try{
         Connection con = new myConnection().getConnection();
         java.sql.Statement stat = con.createStatement();
         String sql = "select max(right (id_detail_bk,4)) as no from detail_barang_keluar";
         ResultSet res = stat.executeQuery(sql);
         while(res.next()){
            if(res.first()==false){
    ...
    public void dataTable(){
        ...
        String sql = "select * from detail_barang_keluar order by tanggal asc";
        try{
    ...
    private void initComponents() {
        ...
        labelKodePart.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
        ...
        labelGudang.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update detail_barang_keluar set tanggal=?,id_detail_bk=?,id_bk=?,gudang=?,kode_part=?,nama_part=?,jumlah=?,keterangan=? where id_detail_bk='"+txtIdDetailBarangKeluar.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (ok==0){
            String sql="delete from detail_barang_keluar where id_bk='"+txtIdBarangKeluar.getText()+"'";
            String sql2="delete from barang_keluar where id_bk='"+txtIdBarangKeluar.getText()+"'";
            try {
                PreparedStatement stat=conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from detail_barang_keluar where id_bk like '%"+txtCari.getText()+"%'"
    ...
    private void txtCariGudangKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariGudangKeyTyped
        String sqlPencarian3 = "select * from gudang where kode_gudang like '%"+txtCariGudang.getText()+"%' or nama_gudang like '%"+txtCariGudang.getText()+"%'";
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        String sql = "insert into detail_barang_keluar values (?,?,?,?,?,?,?,?)";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            ...
            File file = new File("src/report/transaksiBK.jrxml");
