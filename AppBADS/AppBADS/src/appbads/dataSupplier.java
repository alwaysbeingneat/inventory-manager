...
public class dataSupplier extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        labelKodeSupplier.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
        ...
        labelNamaSupplier.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
        ...
        labelNoTelpon.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
        ...
        labelAlamat.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update supplier set tanggal=?,kode_supplier=?,nama_supplier=?,notelpon_supplier=?,alamat_supplier=? where kode_supplier='"+txtKodeSupplier.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from supplier where kode_supplier like '%"+txtCari.getText()+"%' or nama_supplier like '%"+txtCari.getText()+"%'";
