...
public class dataGudang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        labelKodeGudang.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
        ...
        labelNamaGudang.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update gudang set tanggal=?,kode_gudang=?,nama_gudang=?,alamat=?,keterangan=? where kode_gudang='"+txtKodeGudang.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (ok==0){
            String sql="delete from gudang where kode_gudang='"+txtKodeGudang.getText()+"'";
            try {
                PreparedStatement stat=conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from gudang where kode_gudang like '%"+txtCari.getText()+"%' or nama_gudang like '%"+txtCari.getText()+"%'";
