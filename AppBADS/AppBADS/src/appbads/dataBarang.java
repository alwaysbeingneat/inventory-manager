...
public class dataBarang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        labelNamaPart.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
        ...
        labelQty.setFont(new java.awt.Font("Futura Hv BT", 0, 14)); // NOI18N
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update barang set tanggal=?,kode_part=?,nama_part=?,kategori=?,jumlah=?,keterangan=? where kode_part='"+txtKodePart.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (ok==0){
            String sql="delete from barang where kode_part='"+txtKodePart.getText()+"'";
            try {
                PreparedStatement stat=conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from barang where kode_part like '%"+txtCari.getText()+"%' or nama_part like '%"+txtCari.getText()+"%'";
    ...
    private void txtCariKategoriKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKategoriKeyTyped
        String sqlPencarian2 = "select * from kategori where kode_kategori like '%"+txtCariKategori.getText()+"%' or nama_kategori like '%"+txtCariKategori.getText()+"%'";
